...
function test() {
  ...
  const newBrandName = brandName?.charAt(0).toUpperCase() + brandName?.slice(1);

  console.log("ppro", product, typeof product);
        ...
        <div className="basis-2/3  pr-4">
          <div className=" border px-1 flex flex-col h-full justify-between">
            <div className="flex flex-col gap-1">
              <div className="text-sm text-textGray">{product.brandName}</div>
